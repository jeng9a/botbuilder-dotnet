...
namespace Microsoft.Bot.Builder.Ai.Translation
{
    ...
    public class LocaleConverterMiddleware : IMiddleware
    {
        ...
        private readonly BotStatePropertyAccessor<string> _userLocaleProperty;
        ...
        public LocaleConverterMiddleware(BotStatePropertyAccessor<string> userLocaleProperty, string toLocale, ILocaleConverter localeConverter)
        {
